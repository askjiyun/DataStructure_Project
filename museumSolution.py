import itertools
from museum import dijkstra_3d, exhibition_rooms, graph, room_to_floor_and_elevator
...
def find_shortest_path(graph, exhibition_rooms, start_point, end_point, selected_facilities):
    ...
    for path in itertools.permutations(all_stops):
        ...
        for node in path:
            ...
            # 이제 해당 방으로 이동
            distance, _ = dijkstra_3d(graph, current_point, node)
...
selected_facilities = input("관람하고 싶은 편의시설을 입력하세요 (쉼표로 구분): ")
